...
const index = () => {
  ...
  const fetchHabits = async () => {
    try {
      const response = await axios.get(`http://192.168.1.14:3000/habitslist`);
  ...
  const handleCompletion = async () => {
    try {
      ...
      await axios.put(`http://192.168.1.14:3000/habits/${habitId}/completed`, {
  ...
  return (
    <>
      <LinearGradient colors={["#FFC0CB", "#FF69B4"]} style={styles.gradient}>
        <ScrollView style={{ flex: 1, padding: 10 }}>
          ...
          <Text style={{ marginTop: 5, fontSize: 30, fontWeight: "500" }}>
            Cabbit
          </Text>
          ...
          >
            <Pressable
              ...
              style={{
                backgroundColor: option == "Today" ? "#FAF3DD" : "transparent",
            ...
            <Pressable
              ...
              style={{
                backgroundColor: option == "Weekly" ? "#FAF3DD" : "transparent",
                paddingHorizontal: 10,
                paddingVertical: 8,
                borderRadius: 25,
              }}
            ...
            <Pressable
              ...
              style={{
                backgroundColor:
                  option == "Overall" ? "#FAF3DD" : "transparent",
                paddingHorizontal: 10,
                paddingVertical: 8,
                borderRadius: 25,
              }}
